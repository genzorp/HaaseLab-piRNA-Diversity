simpleMetageneRegularGGV4 <- function(
                                      ## INPUT
                                      METAGENE.DT=NULL,
                                      SAMPLE.NAME=NULL,
  ...
  ## PAVOL GENZOR
  ## 11.17.19; Version 1
  ## 02.03.20; Version 3; to match with other function
  ## 03.17.20; Version 4; simplifying the plot
  ## 05.04.20; Version 5; library definitions
